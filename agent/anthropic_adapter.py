...
def _supports_adaptive_thinking(model: str) -> bool:
    ...
    MiniMax M3 is the other documented exception because the M3 Anthropic
    endpoint accepts ``thinking.type=adaptive`` (and silently ignores the
    manual ``enabled+budget_tokens`` shape that M2.x uses).
    """
